...
public class InmateController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Inmate> updateInmate(@PathVariable Long id, @RequestBody @Valid InmateUpdateDto inmateUpdateDto) {
		Inmate inmate = inmateService.updateInmate(id, inmateUpdateDto);
